      ...
      >
          ...
          <div className="absolute right-0 bottom-0 left-0 p-6">
            <div className="flex items-center justify-between gap-3">
              <div className="space-y-2">
                <h3 className="font-bold text-xl text-zinc-900 dark:text-white leading-snug tracking-tight transition-all duration-500">
                  {title}
                </h3>
                <p className="text-base text-zinc-600 dark:text-zinc-400 tracking-tight transition-all duration-500">
                  {subtitle}
                </p>
              </div>
            </div>
        ...
        >
          <div className="flex-1 space-y-4">
            <div className="space-y-2">
              <h3 className="font-semibold text-lg text-zinc-900 dark:text-white leading-snug tracking-tight">
                {title}
              </h3>
          ...
          <div className="mt-6 border-t border-zinc-200 dark:border-zinc-800 pt-4">
            ...
            >
              <span className="font-medium text-sm text-orange-700 dark:text-orange-300 transition-colors duration-300 group-hover/start:text-orange-600 dark:group-hover/start:text-orange-200">
